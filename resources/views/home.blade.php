          ...
          <ul class="solid-bullet-list">
            <li>
              ...
              <div class="image-layers">
                ...
                <img class="img-sm rounded-circle image-layer-item" src="{{ asset("assets/images/faces/face3.jpg") }}"
                  alt="profile" />
                <img class="img-sm rounded-circle image-layer-item" src="{{ asset("assets/images/faces/face5.jpg") }}"
                  alt="profile" />
                <img class="img-sm rounded-circle image-layer-item" src="{{ asset("assets/images/faces/face8.jpg") }}"
                  alt="profile" />
              </div>
            </li>
            <li>
            ...
            <table class="table">
              <tbody>
                <tr>
                  ...
                  <td class="py-1">
                    <img src="{{ asset("assets/images/faces/face13.jpg") }}" alt="profile"
                ...
                <tr>
                  ...
                  <td class="py-1">
                    <img src="{{ asset("assets/images/faces/face11.html") }}" alt="profile"
                      class="img-sm rounded-circle" />
                  </td>
                  <td class="font-weight-bold">
                    Marguerite Phillips
